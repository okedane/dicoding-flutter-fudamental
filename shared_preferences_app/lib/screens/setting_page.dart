...
import 'package:shared_preferences_app/widgets/maximum_pege_size_field.dart';
...
class _SettingPageState extends State<SettingPage> {
  ...
  void saveAction() async {
    ...
    final isNotificationEnabe = NotificationState.isEnable;
    final MaximumPageSize = int.tryParse(maximumPageSizeController.text) ??
        maximumPageSizeNumbers.first;
    final signatuee = signatureController.text;
    final Setting setting = Setting(
      notificationEnable: isNotificationEnabe,
